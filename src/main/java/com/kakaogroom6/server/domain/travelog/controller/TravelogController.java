...
//    @GetMapping("/keyword")
//    public ResponseEntity<TravelogsResponseDto> searchTagTravelogs(@RequestParam String tag){
//        TravelogsResponseDto response = travelogService.searchTagTravelogs(tag);
//    }
